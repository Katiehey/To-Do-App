      ...
      <main className="min-h-screen bg-gray-50 dark:bg-dark-bg transition-colors duration-300">
        <section className="text-center py-20 bg-white dark:bg-dark-card shadow-lg border-b dark:border-dark-border">
          <div className="max-w-4xl mx-auto px-4">
            ...
            <h1 className={darkClass("text-5xl font-extrabold mb-4", textClasses)}>Your Personal Task Manager</h1>
            <p className={darkClass("text-xl mb-8", subtextClasses)}>Organize your life, boost productivity, and never miss a deadline.</p>
            <Link to="/login" className="inline-block bg-blue-600 text-white px-8 py-3 rounded-full text-lg font-semibold hover:bg-blue-700 transition shadow-md">Get Started</Link>
          </div>
        </section>

        <section className="py-20">
          <div className="mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
            <h2 className={darkClass("text-3xl font-bold text-center mb-12", textClasses)}>Features Designed for Productivity</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                ...
                <div key={i} className={darkClass(cardClasses, "p-6 rounded-xl shadow-xl group")}>
                  ...
                  <h3 className={darkClass("text-xl font-semibold mb-2", textClasses)}>{feat.title}</h3>
